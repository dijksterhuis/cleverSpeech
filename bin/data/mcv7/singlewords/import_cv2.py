...
from cleverspeech.models.__DeepSpeech_v0_9_3.src.training.deepspeech_training.util.downloader import SIMPLE_BAR
from cleverspeech.models.__DeepSpeech_v0_9_3.src.training.deepspeech_training.util.importers import (
    get_counter,
...
def _preprocess_data(tsv_dir, audio_dir, datasets, space_after_every_character=False):
    exclude = []
...
def parse_args():
    ...
    parser.add_argument(
        "--dataset",
        default=["test"],
        choices=["test", "dev", "train", "validated", "other"],
        nargs="+",
        help="Choose which dataset to process examples",
    )
    parser.add_argument(
        "--filter_alphabet",
...
def main():
    ...
    _preprocess_data(PARAMS.tsv_dir, audio_dir, PARAMS.dataset, PARAMS.space_after_every_character)
